...
/**
 * Reports tests as failed when affected by hook failures.
 *
 * When enabled, tests that are skipped due to a `before` or `beforeEach` hook
 * failure will be reported as failed instead of pending/skipped.
 *
 * @public
 * @see [CLI option](../#-fail-hook-affected-tests)
 * @param {boolean} [failHookAffectedTests=true] - Whether to fail affected tests.
 * @return {Mocha} this
 * @chainable
 */
